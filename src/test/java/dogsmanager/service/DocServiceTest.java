...
public class DocServiceTest {
    ...
    public void testRemoveDogById() {
        daoMock.removeDogById(Mockito.anyInt());
        Mockito.verify(daoMock, Mockito.times(1)).removeDogById(Mockito.anyInt());
    }

    @Test
    public void testGetDogById() {
        daoMock.getDogById(Mockito.anyInt());
        Mockito.verify(daoMock, Mockito.times(1)).getDogById(Mockito.anyInt());
    }
}
